...
public class RegistrarEquipo extends javax.swing.JFrame {
    ...
    public RegistrarEquipo() {
        ...
        try {
            ...
            System.err.println("Error al consultar el nombre del cliente - revisa RegistrarEquipo.");
        }
    ...
    private void initComponents() {
        ...
        jLabel_nombre5.setText("Daño reportado y obsevaciones");
        ...
        cmb_tipoequipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Acer", "Alienware", "Apple", "Asus", "Brother", "Dell", "HP", "Lenovo", "Samsung", "Toshiba", "Xerox" }));
    ...
    private void jButton_RegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarActionPerformed
        ...
        //Para controlar las fechas de los ingresos de los equipos
        ...
        if (observaciones.equals("")) {
            jTextPane_observaciones.setText("No hay observaciones.");
        }
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Registro extoso.");
                this.dispose();

            } catch (SQLException e) {
                System.err.println("Error en registrar equipo - revisa RegistrarEquipo." + e);
