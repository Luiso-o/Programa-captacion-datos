...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        //consultar informacion de persona en la base de datos
        try {
            ...
            System.err.println("Error en cargar usuario - InformacionUsuario " + e);
    ...
    private void initComponents() {
        ...
        jLabel_Nombre1.setText("Permisos de:");
        ...
        jLabel_Nombre3.setText("Username:");
        getContentPane().add(jLabel_Nombre3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 50, -1, -1));
        ...
        getContentPane().add(jLabel_Nombre4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 59, -1, -1));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, -6, 640, 460));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                ResultSet rs = pst.executeQuery();//realizar una consulta
                ...
                if(rs.next()){
                    ...
                    pst2.executeUpdate();//realizar una modificacion
                    cn2.close();
                ...
                System.err.println("Error al actualizar - Revisa codigo InformacionUsuario." + e);
            }
