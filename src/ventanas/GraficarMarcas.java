...
public class GraficarMarcas extends javax.swing.JFrame {
    ...
    public GraficarMarcas() {
        ...
        try {
            ...
            System.err.println("Error en la consulta\n -revisa GraficarMarcas" + e);
            JOptionPane.showMessageDialog(null, "Error en consultar datos, contacte con el administrador.");
    ...
    public void paint(Graphics g) {
        ...
        g.fillArc(25, 100, 270, 270, grados_acer + grados_alienware + grados_apple
                + grados_asus + grados_brother + grados_dell, grados_hp);
        ...
        g.fillArc(25, 100, 270, 270, grados_acer + grados_alienware + grados_apple
                + grados_asus + grados_brother + grados_dell + grados_hp, grados_lenovo);
        g.fillRect(310, 330, 20, 20);
        g.drawString(lenovo + " de Lenovo", 340, 345);

        //samsung
        g.setColor(new Color(215, 96, 140));//colorrosa
        g.fillArc(25, 100, 270, 270, grados_acer + grados_alienware + grados_apple
                + grados_asus + grados_brother + grados_dell + grados_hp + grados_lenovo,
                 grados_samsung);
