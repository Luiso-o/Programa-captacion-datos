...
public class Informacion_Cliente extends javax.swing.JFrame {
    ...
    DefaultTableModel model = new DefaultTableModel();//interaccion con la tabla
    ...
    public Informacion_Cliente() {
        ...
        try {
            ...
            System.err.println("Error en cargar usuario - revisa Informacion_Cliente " + e);
            JOptionPane.showMessageDialog(null, ""
                    + "Error al cargar!!, contacta con el administrador.");
        }
        ...
        try {
            ...
            System.err.println("Error en el llenado de la tabla equipos - revisa Informacion_Cliente " + e);
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                System.err.println("Error en actualizar cliente - revisa Informacion_Cliente " + e);
                JOptionPane.showMessageDialog(null, "Error al actualizar el cliente!!, contacte al administrador.");
            }
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
        ...
        try {
            ...
            PdfWriter.getInstance(documento, new FileOutputStream("C:/Users/chepo/OneDrive/Escritorio" + txt_nombre.getText().trim() + ".pdf"));
