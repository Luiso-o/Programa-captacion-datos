...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 276, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (validacion == 0) {
                    try {
                        ...
                        System.err.println("Error al registrar usuario /Registrar-Usuarios/" + e);
            ...
            JOptionPane.showMessageDialog(null, "Error al comparar el usuario!!, contacte al administrador.");
        }
    ...
    public void Limpiar() {
        ...
        cmb_niveles.setSelectedIndex(0);//limpiamos el comboBox (lo poneos a la opcion Aministrador)
